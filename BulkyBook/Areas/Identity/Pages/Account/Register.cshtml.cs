...
namespace BulkyBook.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                //var users = new IdentityUser { UserName = Input.Email, Email = Input.Email };
                ...
                if (result.Succeeded)
                {
                    ...
                    //Samo kada se dodaje admin na localhostu
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Confirm your email", massageBody);
